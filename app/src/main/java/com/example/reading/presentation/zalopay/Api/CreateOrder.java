package com.example.reading.presentation.zalopay.Api;

import com.example.reading.presentation.zalopay.Constant.AppInfo;
import com.example.reading.presentation.zalopay.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            Items = "[]";
            BankCode = "zalopayapp";
            Description = "Nạp tiền vào tài khoản Nguyễn Trung Kiên - mã giao dịch: #" + Helpers.getAppTransId();
